...
void RNN_Edge::propagate_forward(int time) {
    // std::cout << "Nodes ID:: " << input_node->innovation_number << "   " << output_node->innovation_number << std::endl;
    // std::cout << "Nodes Type:: " << input_node->layer_type << "   " << output_node->layer_type << std::endl;
